 ...
 */
layui.extend({
    cropper: '{/}https://cdn.cuiliangblog.cn/static/layui-mini/js/lay-module/croppers/cropper' // {/}的意思即代表采用自有路径，即不跟随 base 路径
})
layui.define(['jquery', 'layer', 'cropper'], function (exports) {
    ...
    var obj = {
        render: function (e) {
            ...
            var html = "<link rel=\"stylesheet\" href=\"https://cdn.cuiliangblog.cn/static/layui-mini/js/lay-module/croppers/cropper.css\">\n" +
                ...
                "        </div>\n" +
                "        <div class=\"layui-form-mid layui-word-aux\">图片裁剪后分辨率为：" + saveW + "*" + saveH + "，添加图片后拖动选区，完成图片裁剪上传。</div>\n" +
                "    </div>\n" +
